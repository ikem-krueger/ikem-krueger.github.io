...
The disk on "Sata(0x`0`,0x0,0x0)" belongs to "/dev/disk`0`" with the volumes (partitions):
...
The disk on "Sata(0x`2`,0x0,0x0)" belongs to "/dev/disk`2`" with the volumes (partitions):
